<?php
/*
 * Vue d'administration (suppression) pour le module comments.
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1 class="titre text-center">Modération commentaire : suppression physique</h1>
        </div>
        <div class="col-md-12">
            ...
            <form action="<?php echo ROOT_URL . '/api/comments/delete.php' ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input id="numCom" name="numCom" class="form-control" style="display: none" type="text" value="<?php echo ($ba_bec_numCom); ?>" readonly="readonly" />
                    <input id="dtDelLogCom" name="dtDelLogCom" class="form-control" type="text" value="<?php echo ($ba_bec_dtDelLogCom); ?>"/>
                </div>
