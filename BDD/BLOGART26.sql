...
--
-- Hôte : localhost:8889
-- Généré le : jeu. 19 fév. 2026 à 03:37
...
(38, '2026-02-06 15:35:00', '2026-02-06 15:07:24', 'Une victoire construite ensemble', 'Une performance collective a permis au BEC de décrocher un succès important à domicile.', 'Une victoire qui récompense le collectif.', 'Portée par l’ambiance, l’équipe a montré de la solidarité et une vraie volonté de jouer juste sur les temps fortsvgthy§(gt(ft(&#039;fr', 'Rester solides', 'Le groupe a su répondre présent en défense et gérer les moments clés avec plus de calme et de discipline.', 'Le public au rendez-vous', 'Les tribunes ont apporté une énergie précieuse, notamment dans les passages décisifs du match.', 'Un succès encourageant, qui donne confiance et confirme la dynamique du groupe.', 'article/article-38.jpg', 1),
...
(5, 'SF1', 'Seniors filles 1', 'Bordeaux étudiant club', 'Senior', 'Féminine', 'National 3', 'Equipe SF1', 'photos-equipes/seniors-filles-1-photo-equipe.jpg', 'photos-equipes/seniors-filles-1-photo-staff.webp'),
...
(1, 'SG3', 'Séniors garçons 3', 'Bordeaux étudiant club', 'Senior', 'Masculine', 'Départementale 3', 'adasda', 'photos-equipes/s-eniors-garcons-3-photo-equipe.jpg', 'photos-equipes/s-eniors-garcons-3-photo-staff.jpeg'),
...
(66, 'Bulldozer', 'Danny', 'DRAMET', 'photos-joueurs/DR.danny.jpg', '1993-10-01', 'SG3', 4, 34, '2025-09-01', NULL),
(71, 'Dynamite', 'Jeremy', 'MARCOU', 'photos-joueurs/MA.jeremy.jpg', '1994-06-25', 'SG3', 3, 18, '2025-09-01', NULL),
(64, 'Flash', 'Robin', 'COLLOMB', 'photos-joueurs/CO.robin.jpg', '2005-03-22', 'SG3', 3, 23, '2024-09-01', NULL),
(73, 'L&#039;Éclair', 'Toatini', 'MINIER', NULL, '2007-04-24', 'SG3', 5, 5, '2025-09-01', NULL),
(78, 'Le Boss', 'Mathias', 'VRECH', 'photos-joueurs/VR.mathias.jpeg', '1991-07-09', 'SG2', 4, 24, '2023-09-01', NULL),
(75, 'Le Frelon', 'Théo', 'ROUILLON', 'photos-joueurs/RO.tho.jpg', '1998-07-11', 'SG3', 4, 17, '2023-09-01', NULL),
(72, 'Le Guerrier', 'Erwan', 'MAUSSION', NULL, '1993-09-24', 'SG3', 1, 30, '2021-09-01', NULL),
(77, 'Le Métronome', 'Simon', 'SALLIOU', 'photos-joueurs/SA.simon.jpg', '2004-01-10', 'SG3', 5, 6, '2021-09-01', NULL),
(65, 'Le Mur', 'Martin', 'DAMY', 'photos-joueurs/DA.martin.jpeg', '2004-11-04', 'SG2', 1, 12, '2023-09-01', NULL),
(62, 'Le Phénix', 'Mehdi', 'AFANKOUS', NULL, '2001-04-16', 'SG3', 4, 14, '2022-09-01', NULL),
(69, 'Le Roc', 'Vincent', 'LE BON', NULL, '1999-02-03', 'SG3', 4, 21, '2024-09-01', NULL),
(67, 'Le Sage', 'Iba', 'GENESTIER-SCHMITT', NULL, '1989-07-05', 'SG3', 1, 9, '2022-09-01', NULL),
(63, 'Le Stratège', 'Jean-Guillaume', 'BIDART', 'photos-joueurs/BI.jeanguillaume.jpg', '1984-04-30', 'SG3', 1, 7, '2021-09-01', NULL),
(70, 'Le Vétéran', 'Bastien', 'MARCATTE', 'photos-joueurs/MA.bastien.jpg', '1985-04-05', 'SG3', 2, 15, '2023-09-01', NULL),
(74, 'Maestro', 'Florian', 'PAYET', 'photos-joueurs/PA.florian.jpg', '1997-03-03', 'SG3', 1, 8, '2022-09-01', NULL),
...
(68, 'Sniper', 'Matthieu', 'KUEVIDJEN', 'photos-joueurs/KU.matthieu.jpeg', '2003-08-10', 'SG3', 2, 11, '2021-09-01', NULL),
(76, 'Titan', 'Louis', 'ROUSSEAU', 'photos-joueurs/RO.louis.jpg', '1993-09-09', 'SG3', 2, 33, '2024-09-01', NULL);
...
(38, 'agathelanglois', 'Agathe', 'Langlois', NULL, NULL, NULL, 1, 'SG1', 'Assistante coach', 1, 'Membre du bureau', 1, NULL, 1, 'Responsable animation', 1, 'Responsable communication'),
(29, 'ANIM-BEN4', 'Stephan', 'Sanglar', '/src/uploads/photos-benevoles/sa.stephan.jpeg', 'animation4@bec.fr', '0610000014', 1, 'SG3', 'Coach', 1, 'Trésorier', 1, 'Responsable technique', 0, NULL, 0, NULL),
(36, 'emmanuelbeigbeder', 'Emmanuel', 'Beigbeder', NULL, NULL, NULL, 0, NULL, NULL, 1, 'Président', 0, NULL, 0, NULL, 0, NULL),
(37, 'freddydougoum', 'Freddy', 'Dougoum', NULL, NULL, NULL, 1, 'SF1', 'Coach', 0, NULL, 1, 'Coach', 0, NULL, 0, NULL),
(1, 'mehdiafankous', 'mehdi', 'afankous', '/src/uploads/photos-benevoles/af.mehdi.jpeg', NULL, NULL, 0, NULL, NULL, 0, NULL, 0, NULL, 0, NULL, 1, 'Photographe - Vidéaste');
...
--
ALTER TABLE `JOUEUR`
  MODIFY `numJoueur` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
...
--
ALTER TABLE `PERSONNEL`
  MODIFY `numPersonnel` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
